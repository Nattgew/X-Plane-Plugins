...
class PythonInterface:
	...
	def gameLoopCallback(self, inElapsedSinceLastCall, elapsedSim, counter, refcon):
		...
		if (vvi >= 500 and alt >= (self.trans_alt-25) or vvi < 500 and alt > self.trans_alt + 250) and self.stdpress==0:
			# Climbing through 18000
			print "Climbing through transition alt"
			bar=29.92
			self.stdpress=1
			self.setBaro(bar)
		elif (vvi <= -500 and alt < (self.trans_alt-25) or vvi > -500 and alt < self.trans_alt - 250) and self.stdpress==1:
