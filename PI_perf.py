...
class PythonInterface:
	...
	def getFL(self,dalt,alt_ind,aphdg):
		...
		if self.aircraft.name=="PC12":
			...
			flimit=math.pow(0.74,(wgt/1000-20))+25.75
		...
		if AC=="B738":
			...
			if flap_i==-1:
				...
				if flaps==1: #Flaps 8  V2,Vr,V1
					...
					speed=(((143,137,138),(138,132,130),(133,127,125),(127,119,115),(122,113,109),(117,107,102)), #-40 to 10
					((143,140,138),(138,132,131),(133,128,124),(127,120,116),(112,114,110),(117,108,103)), #11-20
					((143,141,141),(138,133,133),(133,129,127),(127,121,117),(122,115,111),(117,109,105)), #21-30
					((143,142,142),(138,134,134),(133,130,128),(127,123,119),(122,116,113),(117,111,107)), #31-40
					((143,142,142),(138,134,134),(133,130,128),(127,123,119),(122,116,113),(117,111,107))) #41-50
